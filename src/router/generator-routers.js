...
const constantRouterComponents = {
  ...
  'Basic': () => import('@/views/module/Basic'),
  'BasicDetailPage': () => import('@/views/module/Basic/detailPage.vue'),

  'Address': () => import('@/views/module/Address'),
  'AddressDetailPage': () => import('@/views/module/Address/detailPage.vue'),
}
