<template>
  <div class="main user-layout-register">
    ...
    <a-form-model ref="form" :model="form" :rules="rules">
      <a-alert v-if="isRegisterError" type="error" showIcon style="margin-bottom: 24px" :message="registerErrorInfo"
        closable :after-close="handleCloseRegisterError" />
      <a-form-model-item prop="username">
        <a-input v-model.trim="form.username" size="large" autocomplete="off" placeholder="账户" />
      </a-form-model-item>
      <a-form-model-item has-feedback prop="password">
        <a-input-password v-model.trim="form.password" size="large" autocomplete="off" placeholder="密码" />
      </a-form-model-item>
      <a-form-model-item has-feedback prop="confirmPassword">
        <a-input-password v-model.trim="form.confirmPassword" size="large" autocomplete="off" placeholder="确认密码"
          :maxLength="20" />
      </a-form-model-item>
      ...
      <a-form-item>
        <a-button size="large" type="primary" htmlType="submit" class="register-button" :loading="registering"
          @click.stop.prevent="handleRegister" :disabled="registering">
          注册
        </a-button>
